...
#  <p align="center">👋🏻 Hi,I'm Ahmed Al-Aini </p> <p>Systems Architect in the Making </p>
...
PHP • MySQL • Bootstrap 5 • Session Management • CRUD Operations

```

| Feature | Description |
|---------|-------------|
| 👨‍⚕️ Patient Registry | Full CRUD with medical history tracking |
| 📅 Appointment Engine | Schedule, reschedule, cancel with conflict detection |
...
C++ • File I/O • OOP • Data Persistence • CSV Storage
...
C++ • Stack • Queue • Dynamic Memory Management

```

- Undo/Redo functionality via stack implementation
